...
///
/// Values of this type are generated by [`crate::xabi`] on traits. Test helpers
/// can collect the current contract layout and compare it with committed
/// snapshots.
pub struct XabiLayout {
    ...
    /// Contract represented by this layout.
    pub contract: XabiContractLayout,
    /// Collect boundary layout entries for this contract.
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub struct XabiContractLayout {
    /// Stable trait ABI identifier.
    pub abi_id: &'static str,
    /// Contract ABI version.
    pub abi_version: u32,
    /// Rust trait path that declared this contract.
    pub rust_trait: &'static str,
}

impl XabiContractLayout {
    /// Create contract layout metadata.
    pub const fn new(abi_id: &'static str, abi_version: u32, rust_trait: &'static str) -> Self {
        Self {
            abi_id,
            abi_version,
            rust_trait,
